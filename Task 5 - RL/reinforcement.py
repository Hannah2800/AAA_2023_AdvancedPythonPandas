...
class SmartChargingEnv(gym.Env):
    ...
    def __init__(self, battery_capacity=200, time_coefficient=15):
        ...
        self.observation_space = gym.spaces.Tuple([gym.spaces.Discrete(self.time_limit + 1, start=0), gym.spaces.Discrete(battery_capacity + 1, start=0)])
    ...
    def step(self, action):
        ...
        reward -= self._get_charging_cost(action)
    ...
    def _get_charging_cost(self, coefficient_p):
        return self.time_coefficient * math.exp(coefficient_p)
